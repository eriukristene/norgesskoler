...
var vgsMysen = L.circle([59.556741, 11.327686], {color: "black", fillColor: "red", weight: 1, fillOpacity: 0.7, radius: 2500});
...
var circle = L.circleMarker([59.280776, 11.104585], { color: 'purple', fillColor: "purple", fillOpacity: 0.7, radius: 2500});
...
var smallSchoolsGroup = L.layerGroup([vgsNumedal, vgsHolmen, vgsKjelle, circle]).addTo(mymap);
